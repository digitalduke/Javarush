...
host = "mongodb+srv://digitalduke:F4jVkWawvvqIf1XG@mflix-jsfgm.mongodb.net/test"
...
print("%s documents to migrate" % len(movies_to_migrate))
...
try:
    ...
    print("%s documents updated" % bulk_results.modified_count)
